<div class="rbt-team-modal modal fade rbt-modal-default" tabindex="-1" id="deleteModal-{{ $mail_data->id }}"
    aria-labelledby="deleteModal-{{ $mail_data->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="{{ route('mail.destroy', $mail_data->id) }}">
                @csrf
                @method('DELETE')
