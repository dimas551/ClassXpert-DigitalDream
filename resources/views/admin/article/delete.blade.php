<div class="rbt-team-modal modal fade rbt-modal-default" tabindex="-1" id="deleteModal-{{ $article_data->id }}"
    aria-labelledby="deleteModal-{{ $article_data->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form method="POST" action="{{ route('article.destroy', $article_data->id) }}">
                @csrf
                @method('DELETE')
