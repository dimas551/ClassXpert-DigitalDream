                                        ...
                                        <tbody>
                                            @foreach($articles as $article_data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="h6 mb--5">
                                                            <span class="badge {{ $article_data->status === 'draft' ? 'bg-danger' : 'bg-success' }}">
                                                                {{ ucfirst($article_data->status) }}
                                                            </span>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="h6 mb--5">{{ $article_data->category->name }}</span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('article.show', $article_data->id) }}" class="badge bg-primary text-white content-btn" data-id="{{ $article_data->id }}" data-bs-toggle="modal" data-bs-target="#contentModal-{{ $article_data->id }}">View Content
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <div class="rbt-button-group justify-content-end">
                                                            ...
                                                            <a class="rbt-btn-link left-icon text-danger" href="#"><i
